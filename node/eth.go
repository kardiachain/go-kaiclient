...
import (
	...
	"github.com/kardiachain/go-kaiclient/hexutil"
	"github.com/kardiachain/go-kaiclient/rpc"
	"github.com/kardiachain/go-kaiclient/types"
	"github.com/kardiachain/go-kaiclient/utils"
...
func (e *Eth) SetTxPollTimeout(timeout int) {
	if timeout == 0 {
		// default tx poll timeout is 120s
		e.txPollTimeout = 120
		return
	}
...
func (e *Eth) GetBlockHeaderByNumber(number *big.Int, full bool) (*types.Header, error) {
...
// Get block header by block number
func (e *Eth) GetBlockByNumber(number *big.Int, full bool) (*types.Block, error) {
	return e.getBlock("eth_getBlockByNumber", toBlockNumArg(number), full)
}

// Get block by block hash
func (e *Eth) GetBlockByHash(hash common.Hash, full bool) (*types.Block, error) {
	var b *types.Block
...
// Send transaction
func (e *Eth) SendTransaction(txn *types.Transaction) (common.Hash, error) {
...
func (e *Eth) GetTransactionByHash(hash common.Hash) (*types.Transaction, error) {
...
func (e *Eth) GetTransactionReceipt(hash common.Hash) (*types.Receipt, error) {
...
func (e *Eth) GetLogs(fliter *types.Filter) ([]*types.Event, error) {
